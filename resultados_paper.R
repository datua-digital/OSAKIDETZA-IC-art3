...
### all results and values for the publication


# all patient; sexo, edad; value; slope-value; slope -------------------------------------------------
...
saveRDS(JM_table, file = 'JMtable_all_sexoedad.rds')
rm("M1", "M2", "M3")
# all patient; sexo, edad, charlson -------------------------------------------------
df_jm <- readr::read_csv("data/out/df_JM.csv")
...
JM_table <- summary_table(m1 = M1, m2 = M2, m3 = M3, cox_vars = c("sexo", "edad_ing1", "charlson"))
JM_table$auc <- c(m1 = auc1$auc, m2 = auc2$auc, m3 = auc3$auc) 
saveRDS(JM_table, file = 'JMtable_all_sexoedadcharlson.rds')
rm("M1", "M2", "M3")

# all patient; sexo, edad, charlson, fe reducida -------------------------------------------------
df_jm <- readr::read_csv("data/out/df_JM.csv")
...
JM_table <- summary_table(m1 = M1, m2 = M2, m3 = M3, cox_vars = c("sexo", "edad_ing1", "charlson", "fe.reducida.severa"))
JM_table$auc <- c(m1 = auc1$auc, m2 = auc2$auc, m3 = auc3$auc) 
saveRDS(JM_table, file = 'JMtable_all_sexoedadcharlsonfereducida.rds')
rm("M1", "M2", "M3")
