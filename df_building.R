...
source(paste0(BUILDING_SCRIPTS_PATH, 'prescription_aggregation.R'), encoding = 'UTF-8')
...
baseJoinModel2 <- aggregate_prescriptions(baseJoinModel1)


# Data organized in monthly chunks
baseJoinModel3 <- rearranged_in_months(baseJoinModel1)
